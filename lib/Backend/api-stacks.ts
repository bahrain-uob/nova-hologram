...
export class APIStack extends cdk.Stack {
  constructor(
    ...
    const newGetBookInfoApi = new apigateway.RestApi(
      this,
      "NewGetBookInfoApi",
      {
    ...
    const newGetBookInfoResource =
      newGetBookInfoApi.root.addResource("get-book-info");
    ...
    const newBookUploadPresignApi = new apigatewayv2.HttpApi(
      this,
      "NewBookUploadPresignApi",
      {
    ...
    const newUpdateBookApi = new apigatewayv2.HttpApi(
      this,
      "NewUpdateBookApi",
      {
    ...
    const newDeleteBookApi = new apigatewayv2.HttpApi(
      this,
      "NewDeleteBookApi",
      {
    ...
    const newGetAllBooksApi = new apigatewayv2.HttpApi(
      this,
      "NewGetAllBooksApi",
      {
    ...
    const getUploadUrlsResource =
      librarianApi.root.addResource("get-upload-urls");
    ...
    readerApi.root
      ...
      .addMethod(
        "POST",
        new apigateway.LambdaIntegration(lambdaStack.messageProcessing)
      );
    ...
    librarianApi.root
      ...
      .addMethod(
        "POST",
        new apigateway.LambdaIntegration(lambdaStack.invokeBedrockLib)
      );
    ...
    const readingListAPI = new apigatewayv2.HttpApi(this, "ReadingListAPI", {
    ...
    readingListAPI.addRoutes({
      path: "/reading-list",
      methods: [apigatewayv2.HttpMethod.POST],
      integration: new integrations.HttpLambdaIntegration(
        "GetReadingListIntegration",
        lambdaStack.addToReadingListLambda
      ),
    });
    ...
    const reviewsApi = new apigatewayv2.HttpApi(this, "ReviewsApiV2", {
      apiName: "Book Reviews API",
      corsPreflight: {
        allowOrigins: ["*"],
        allowMethods: [
          apigatewayv2.CorsHttpMethod.GET,
    ...
    // POST /reviews - Create a review
    reviewsApi.addRoutes({
      path: "/reviews",
      methods: [apigatewayv2.HttpMethod.POST],
      integration: new integrations.HttpLambdaIntegration(
        "CreateReviewIntegration",
        lambdaStack.createReview
      ),
    });
    ...
    reviewsApi.addRoutes({
      ...
      integration: new integrations.HttpLambdaIntegration(
        ...
        lambdaStack.getReview
      ),
    });

    // Output API endpoint
    new cdk.CfnOutput(this, "ReviewsApiEndpoint", {
      value: reviewsApi.apiEndpoint,
      description: "Reviews API Gateway endpoint",
    });

    new cdk.CfnOutput(this, "AddToReadingListUrl", {
      value: `${readerApi.url}books/add-to-reading-list`,
    });
    ...
    new cdk.CfnOutput(this, "QATableName", {
      value: dbStack.qaTable.tableName,
    });
